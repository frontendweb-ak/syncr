          ...
          <Button variant="outline" type="button" className="w-full gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <svg className="size-5" viewBox="0 0 48 48" aria-hidden="true">
                ...
                <path
                  fill="#4CAF50"
                  d="M24 44c5.2 0 10-2 13.5-5.2l-6.2-5.2c-2.1 1.6-4.7 2.4-7.3 2.4-5.2 0-9.6-3.3-11.1-8l-6.6 5.1C9.7 39.7 16.3 44 24 44z"
                />
                <path
                  fill="#1976D2"
                  d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.1-3.3 5.5-6.2 7.1l6.2 5.2C39 37 44 31.2 44 24c0-1.3-.1-2.4-.4-3.5z"
                />
              </svg>
            </svg>
            Login with Google
